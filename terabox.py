...
bot_token = os.environ.get('BOT_TOKEN', '7198441390:AAF8ISZ15c4IwX89Gtb2YmWHkawdfJIQgoI')
if len(bot_token) == 0:
...
async def start_command(client, message):
    ...
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ ⚡️", url="https://t.me/Scorpsnighs")
